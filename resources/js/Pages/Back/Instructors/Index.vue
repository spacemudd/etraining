        ...
        <div class="container px-6 mx-auto grid pt-6">
            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr v-for="instructor in instructors.data" :key="instructors.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                        <td class="border-t">
        ...
        watch: {
            form: {
                handler: throttle(function() {
                    ...
                    this.$inertia.replace(this.route('instructor', Object.keys(query).length ? query : { remember: 'forget' }))
                }, 150),
                deep: true,
            },
        },
