...
class BulkCourseSessionsAttendanceSummarySheetExport implements WithMultipleSheets
{
    use Exportable;
    ...
    public function sheets(): array
    {
        ...
        $sheets[] = new BulkCourseBatchSessionAttendanceSummarySheet($this->courseBatchSessions, $reportsIds, $this->startDate, $this->endDate, $this->companyId);
