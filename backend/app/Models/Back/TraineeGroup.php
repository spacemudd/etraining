...
class TraineeGroup extends Model implements Auditable
{
    ...
    public function getClassTimingsAttribute()
    {
        switch ($this->name) {
                ...
                case 'شعبة 15':
                case 'شعبة 13':
            return 'من الأحد الى الأربعاء الساعة  01:00 مساءا الى 03:00 مساءا';
            ...
            case 'شعبة 11':
            case 'شعبة 19':
                return 'من الأحد الى الأربعاء الساعة  10:00 صباحا الى 12:00 مساءا';
            case 'شعبة 9':
            case 'شعبة 14':
            case 'شعبة 16':
            case 'شعبة 17':
                return 'من الأحد الى الأربعاء الساعة  08:00 صباحا الى 10:00 صباحا';
        }
        return;
    }
}
