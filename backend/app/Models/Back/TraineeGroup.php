...
class TraineeGroup extends Model implements Auditable
{
    ...
    public function getClassTimingsAttribute()
    {
        switch ($this->name) {
            ...
            case 'شعبة 1':
            case 'شعبة 15':
                return 'من الأحد الى الأربعاء الساعة 1:00 الى 03:00 مساءً';
            case 'شعبة 6':
            case 'شعبة 12':
            case 'شعبة 2':
                return 'من الأحد الى الأربعاء الساعة 10:00 الى 12:00 ظهراً';
            case 'شعبة 8':
            case 'شعبة 10':
            case 'شعبة 11':
            case 'شعبة 3':
            ...
            case 'شعبة 13':
            case 'شعبة 4':
                return 'من الأحد الى الأربعاء الساعة 1:00 الى 3:00 مساءً';
            case 'شعبة 9':
            case 'شعبة 14':
            case 'شعبة 16':
            case 'شعبة 17':
