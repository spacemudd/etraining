...
return [
    ...
    'tabby-method' => 'تابي - ادفع لاحقاً',
    'choose-tabby-plan' => 'اختر خطة الدفع:',
    'installments' => 'أقساط',
    'loading-tabby-options' => 'جاري تحميل خيارات تابي',
    'pay-with-tabby' => 'ادفع عبر تابي',
    'please-select-tabby-plan' => 'يرجى اختيار خطة تابي',
    'invalid-tabby-plan' => 'خطة تابي غير صحيحة',
    'tabby-no-plans-available' => 'لا توجد خطط تابي متاحة حالياً',
    'error' => 'خطأ',
