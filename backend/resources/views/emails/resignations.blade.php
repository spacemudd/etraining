...
تم إيقافها من البرنامج التدريبي بناء على رغبتها وطلبها، ومرفق لكم المستندات المستلمة . مع تحياتنا
...
@endif
    ...
    @slot('footer')
        @component('mail::resignation-footer')
            البريد الالكتروني مرسل عن طريق النظام الإلكتروني بشكل تلقائي من قبل المتدربة والمستندات المرفقة مرفوعة من قبلها وفي حالة وجود اي ملاحظة لا تترددوا بالتواصل معنا على البريد الالكتروني المعتمد في العقدة.
            <br/>
