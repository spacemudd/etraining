        ...
        <div style="page-break-inside: avoid !important;display:block;">
                <table class="table" style="width:100%;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="100%" style="background:#e0e0e0;text-align: center;">** يعتبر الكشف صحيح ما لم يردنا اي ملاحظات خلال الاسبوع من الارسال ({{ optional($report->approved_at)->setTimezone('Asia/Riyadh')->toDateTimeString() }})</td>
                        </tr>
                    </tbody>
                </table>
