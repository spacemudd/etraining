...
<body>
    <div class="content">
        ...
        <h1 style="margin-top:5rem;">شهادة حضور دورة تطويرية</h1>
        ...
        <p style="margin-top:2.5rem;">قـــد حضرت دورة</p>
        <p style="margin-top:2.5rem;">({{ $certificate->course->name_ar }})</p>
        <p style="margin-top:2.5rem;">عدد ساعاتها التدريبية 32 ساعة</p>
