...
<body>
    <div class="content">
        ...
        <p style="margin-top:2.5rem;">وعدد أيامها التدريبية (3) يوم والمنعقدة في الفترة من </p>
        <p style="margin-top:2.5rem;">(8 - 6 - 1444هـ  إلى 10 - 7 - 1444هـ  )</p>
        <p style="margin-top:2.5rem;">والمعتمدة من المؤسسة العامة للتدريب التقني والمهني برقم </p>
        <p style="margin-top:2.5rem;">(192268218)</p>
        ...
        <div class="row" style="margin-top: 2rem;">
            ...
            <div class="col-4" style="text-align: right;">
                <p class="small-text">
                    <b>حررت بتاريخ:    22 / 7  /1444  هـ </b><br/>
                    <b>الموافق:            13 /  02 /2023 م</b>
                </p>
