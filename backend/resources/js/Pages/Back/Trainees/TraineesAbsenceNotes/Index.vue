        ...
        <div class="container px-6 mx-auto grid pt-6">
            ...
            <div class="flex justify-between">
                ...
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <inertia-link :href="route('back.trainees.absence-notes.index')" class="rounded items-center mr-3 justify-start float-left px-3 py-2.5 bg-yellow-200 hover:bg-yellow-300 text-left">
                        {{ $t('words.manage-absence-notes') }}
                    </inertia-link>
