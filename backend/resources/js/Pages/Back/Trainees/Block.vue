        ...
        <div class="container px-6 mx-auto grid pt-6">
            ...
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-2">
                    ...
                    <jet-textarea id="description" type="text" class="mt-1 block w-full bg-white" v-model="deleted_remark" autocomplete="off" requried/>
                </div>

            </div>

            <div class=" gap-6 items-center">
                <button @click="blockTrainee" class="flex items-center justify-start float-left rounded-md px-4 py-2 bg-red-300 hover:bg-red-400">
                        {{ $t('words.block-trainee') }}
                </button>
            </div>
