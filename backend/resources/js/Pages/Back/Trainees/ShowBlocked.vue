  ...
  <app-layout>
    <div class="container px-6 mx-auto grid pt-6">
      ...
      <div class="grid grid-cols-6 gap-6">
        <div
          class="col-span-6 items-center justify-end bg-gray-50 text-right gap-6"
        >
          <a
            :href="
          ...
          <button
            @click="unblock"
            class="items-center justify-end rounded-md px-4 py-2 bg-red-600 hover:bg-red-600 text-right text-white"
          >
            {{ $t("words.unblock") }}
          </button>
        </div>
        ...
        >
          <gosi-container
            :nin-or-iqama="trainee.identity_number"
          ></gosi-container>
        </div>
        ...
        <div class="col-span-6 sm:col-span-2">
          ...
          <jet-input
            ...
            type="text"
            :class="editButton.inputClass"
            v-model="trainee.deleted_at_timezone"
            :disabled="!editButton.editOption"
          />
        </div>
        ...
        <div class="col-span-6 sm:col-span-6">
          ...
          <div v-if="showPasswordInput && !passwordUpdated" class="mt-2">
            <input
              v-model="newPassword"
              type="password"
            ...
            <button
              ...
              class="ml-4 p-2 bg-green-500 text-white rounded-lg"
            >
              إرسال
            </button>
...
export default {
  ...
  methods: {
    saveDeletedRemark(trainee) {
      NProgress.start();
      axios
        .put(route("back.trainees.update-deleted-remark", trainee.id), {
    ...
    unblock() {
      if (
        confirm(
          this.$t("words.are-you-sure") + " " + this.trainee.deleted_remark
        )
      ) {
        this.$inertia.post(
          route("back.trainees.unblock", { trainee_id: this.trainee.id })
        );
      }
    },
