                ...
                <div class="col-span-3 bg-white shadow-xs rounded-lg p-5">
                    <form class="mt-2" @submit.prevent="submitForm">
                        ...
                        <div class="mt-2">
                            ...
                            <p class="text-sm mt-1 text-gray-500">يرجى فصل الإيميلات بعلامة الفاصلة هكذا: email1@gmail.com, email2@gmail.com</p>
                        </div>
...
export default {
    ...
    methods: {
        submitForm() {
            this.$inertia.put(route('back.settings.complaints.update'), this.form);
        },
    }
}
</script>
