        ...
        <div class="container px-6 mx-auto grid pt-6">
            <breadcrumb-container
                :crumbs="[
                    ...
                    {title: 'attendance-bulk-courses', link: route('back.reports.bulk-course-attendances.index')},
                ]"
            ></breadcrumb-container>
            ...
            <template v-if="report_status === 'new'">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6 mt-5">
                        <jet-label class="mb-2" for="courses_ids" :value="$t('words.course')" />
                        <div class="relative">
    ...
    export default {
        ...
        mounted() {
            if (this.courses.length) {
                this.form.courses_ids = [this.courses[0].id];
            }
        },
        data() {
            return {
        ...
        methods: {
            generateReport() {
                ...
                axios.post(route('back.reports.bulk-course-attendances.generate'), this.form)
                    .then(response => {
