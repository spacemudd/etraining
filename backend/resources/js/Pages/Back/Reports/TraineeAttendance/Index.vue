        ...
        <div class="container px-6 mx-auto grid pt-6">
            <breadcrumb-container
                :crumbs="[
                    ...
                    {title: 'trainee-attendance', link: route('back.reports.trainee-attendance.index')},
                ]"
            ></breadcrumb-container>
            ...
            <template v-if="report_status === 'processing'">
                <div class="mt-10">
                    ...
                    <div v-if="progress_percentage > 0" class="text-center text-gray-600 mt-4">
                        {{ progress_percentage }}%
                    </div>
...
<script>
    ...
    export default {
        metaInfo() {
            return {
                title: this.$t('words.trainee-attendance'),
            }
        },
        components: {
            IconNavigate,
        ...
        methods: {
            generateReport() {
                ...
                axios.post(route('back.reports.trainee-attendance.generate'), this.form)
                    .then(response => {
