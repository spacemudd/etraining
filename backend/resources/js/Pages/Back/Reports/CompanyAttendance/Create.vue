...
<template>
    <app-layout>
        ...
        <div class="container px-6 mx-auto">
            <jet-form-section @submitted="createReport">
            <template #title>
            ...
            <template #form>
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <select-company class="mt-2"
                          v-model="createAttendanceReportForm.company_id"
                          :required="true"
                    />
            ...
            <template #actions>
                <jet-action-message :on="createAttendanceReportForm.recentlySuccessful" class="mr-3">
                    {{ $t('words.created-successfully') }}
                </jet-action-message>

                <jet-button :class="{ 'opacity-25': createAttendanceReportForm.processing }" :disabled="createAttendanceReportForm.processing">
                    {{ $t('words.save') }}
                </jet-button>
            </template>
        </jet-form-section>
...
<script>
    ...
    export default {
      ...
      filters: {
        ...
        methods: {
            createReport() {
                this.createAttendanceReportForm.post(route('back.reports.company-attendance.store'))
            },
        },
    }
</script>
