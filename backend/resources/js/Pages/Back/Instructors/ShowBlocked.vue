        ...
        data() {
            return {
                ...
                dropzoneOptionsCvFull: {
                    ...
                    dictDefaultMessage: "<ion-icon name='cloud-upload-outline' class='text-red-500' size='large'></ion-icon><br/> "+this.$t('words.no-file-available'),
                    thumbnailWidth: 150,
                    maxFilesize: 20,
                },
        ...
        methods: {
            unblock() {
                if (confirm(this.$t('words.are-you-sure'))) {
                    this.$inertia.post(route('back.instructors.unblock', {instructor_id: this.instructor.id}));
                }
            },
