        ...
        <div class="container px-6 mx-auto grid pt-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div>
                        <inertia-link class="font-bold text-center mt-5 inline-flex items-center px-4 py-2 bg-gray-700 hover:bg-red-700 active:bg-red-900 border border-transparent rounded-md font-semibold text-xs text-white uppercase ltr:tracking-widest focus:outline-none focus:border-gray-900 focus:shadow-outline-gray transition ease-in-out duration-150 disabled:cursor-not-allowed"
