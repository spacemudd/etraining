                    ...
                    <div class="flex flex-col justify-start rounded bg-gray-50 rounded shadow-lg p-5">
                        <div class="w-full p-4">
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="font-bold my-0.5">{{ $t('words.payment-link') }}</div>
                                <div class="my-0.5 flex items-center gap-2">
                                    <input type="text" :value="invoice.noon_link" class="bg-gray-100 px-3 py-1 rounded-md flex-grow" readonly />
                                    <button @click="copyToClipboard(invoice.noon_link)" class="bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-600 flex items-center gap-1">
