            ...
            <template v-if="report_status === 'new'">
                ...
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6 mt-5">
                        ...
                        <div class="relative">
                            <datalist class="block appearance-none w-full border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
