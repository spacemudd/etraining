                    ...
                    <template #body>
                        <tr v-for="invoice in invoices.data" :key="invoice.id">
                            <td class="sticky-col sticky-col-first">
                                <inertia-link class="hover:text-blue-600 cell-truncate" :title="invoice.trainee ? invoice.trainee.name : '-'" :href="invoice.trainee.show_url">{{ invoice.trainee ? invoice.trainee.name : '-' }}</inertia-link>
                            </td>
