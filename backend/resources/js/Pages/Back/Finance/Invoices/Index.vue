                        ...
                        <tr v-for="invoice in invoices.data" :key="invoice.id">
                            <td class="sticky-col sticky-col-first">
                                <div class="flex items-start gap-2">
                                    ...
                                    <div class="min-w-0">
                                        <inertia-link
                                            class="hover:text-blue-600 cell-truncate block font-medium"
                                            :title="invoice.trainee ? invoice.trainee.name : '-'"
                                            :href="invoice.trainee && invoice.trainee.show_url ? invoice.trainee.show_url : (invoice.trainee_id ? route('back.trainees.show', invoice.trainee_id) : '#')"
                                        >
                                            {{ invoice.trainee ? invoice.trainee.name : '-' }}
                                        </inertia-link>
                                        <inertia-link
