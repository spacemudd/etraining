        ...
        <div class="container px-6 mx-auto grid pt-6">
            <breadcrumb-container
                :crumbs="[
                    ...
                    {title_raw: $t('words.course-batches')},
                    {title_raw: $t('words.new')}
                ]"
            ></breadcrumb-container>
            ...
            <div class="mt-4">
                <jet-form-section @submitted="createCourse">
                    ...
                    <template #actions>
                        ...
                        <inertia-link :href="route('back.courses.show', {course_id: course.id})" class="flex items-center justify-start rtl:ml-4 ltr:mr-4 rounded-md px-4 py-2 bg-white hover:bg-gray-300 text-right">
                            {{ $t('words.cancel') }}
                        </inertia-link>
