        ...
        <div class="container px-6 mx-auto grid pt-6">
            <breadcrumb-container
                :crumbs="[
                    ...
                    {title: 'companies', link: route('sales.companies.index')},
                ]"
            ></breadcrumb-container>
            <div class="flex justify-between">
                ...
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <!--    </select>-->
                    <!--</search-filter>-->
                    <inertia-link class="btn-gray" :href="route('sales.companies.create')">
            ...
            <div class="bg-white rounded shadow overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tr v-for="company in companies.data" :key="company.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                        <td class="border-t">
                            <inertia-link class="px-6 py-4 flex items-center focus:text-indigo-500" :href="route('sales.companies.show', company.id)">
                                {{ company.name_ar }}<br/>
                                {{ company.name_en }}
                        ...
                        <td class="border-t">
                            <inertia-link class="px-6 py-4 flex items-center" :href="route('sales.companies.show', company.id)" tabindex="-1">
                        ...
                        <td class="border-t w-px">
                            <inertia-link class="px-4 flex items-center" :href="route('sales.companies.show', company.id)" tabindex="-1">
