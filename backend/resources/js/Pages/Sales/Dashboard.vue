    ...
    <app-sales-layout>
        <div class="container px-6 mx-auto grid">
            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 mt-6">
                <!-- Card -->
                <header-card :href="route('back.companies.index')" :title-value="$t('words.companies')" :count-value="1" icon-path="/img/building.svg"></header-card>
            </div>
...
<script>
    import AppSalesLayout from './../Layouts/AppSalesLayout'
