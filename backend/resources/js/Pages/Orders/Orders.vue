<template>
    <app-layout>
        <div class="container px-6 mx-auto grid pt-6" v-can="'view-orders'">
            <breadcrumb-container
                :crumbs="[
                    {title: 'dashboard', link: route('dashboard')},
                    {title: 'orders', link: route('orders-list')},
                ]"
            ></breadcrumb-container>
...
<!--                    </template>-->
<!--                    <template #body>-->
<!--                        <tr v-if="new_emails.created_by_id === user.id">-->
<!--                            <td class="rtl:text-right text-black">-->
<!--                            <div v-if="mail.status === 0 && new_emails.created_by_id === user.id" >-->
<!--                                        <span class="text-black bg-yellow-200 rounded-lg px-3 py-1 font-bold border-solid border-2 border-yellow-200">-->
<!--                                            {{ mail.status_formatted }}-->
<!--                                        </span>-->
<!--                            </div>-->
<!--                            <div v-if="mail.status === 1 && new_emails.created_by_id === user.id">-->
<!--                                        <span class="text-black bg-green-200 rounded-lg px-3 py-1 font-bold border-solid border-2 border-green-200">-->
<!--                                            {{ mail.status_formatted }}-->
<!--                                        </span>-->
<!--                            </div>-->
<!--                            <div v-if="mail.status === 2 && new_emails.created_by_id === user.id">-->
<!--                                        <span class="text-black bg-red-200 rounded-lg px-3 py-1 font-bold border-solid border-2 border-red-200">-->
<!--                                            {{ mail.status_formatted }}-->
<!--                                        </span>-->
<!--                            </div>-->
<!--                            </td>-->
<!--                            <td :style="{background: ['#f7f7f7'], right: [0], top: ['35px']}" v-if="new_emails.created_by_id === user.id">-->
<!--                                {{ mail.number }}-->
<!--                            </td>-->
<!--                            <td class="rtl:text-right text-black" v-if="new_emails.created_by_id === user.id">-->
<!--                                {{ mail.applicant }}-->
<!--                                <br>-->
<!--                                {{ mail.job_title }}-->
<!--                                <br>-->
