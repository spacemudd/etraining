export default {
    "ar": {
        ...
        "words": {
            ...
            "withdraw-from-training-program": "الانسحاب من البرنامج التدريبي",
            "withdraw-information": "عزيزتي المتدربة، يمكنك الانسحاب في أي وقت من برنامجنا التدريبي بالضغط أدناه وسوف يقوم فريق دعم العملاء بالتواصل معك قريبًا لمتابعة الإجراءات.",
            "you-currently-have-a-pending-withdrawal": "لديك طلب انسحاب جاري العمل عليه",
            "withdraw": "انسحاب",
            "withdraw-application": "طلب انسحاب",
            "withdraw-application-information": "",
            "download-the-withdraw-application": "تحميل نموذج الانسحاب",
            "complete-the-form": "يرجى تعبئة النموذج كاملاً",
            "upload-the-form-below": "يرجى رفع النموذج الكامل أدناه",
            "completed-withdrawal-application-copy": "نموذج الانسحاب المكتمل",
            "responsibility-disclaimer": "أتعهد بأن جميع المعلومات المقدمة في هذا الطلب صحيحة، وأنه في حال ثبوت خلاف ذلك أكون مسؤولاً كاملاً عن النتائج.",
    ...
    "en": {
        ...
        "words": {
            ...
            "resignations": "WithdrawalRequests",
            ...
            "withdraw-from-training-program": "Withdraw from training program",
            "withdraw-information": "Dear trainee, you can withdraw anytime from our training program by clicking below and our customer support will be in contact with you shortly to proceed with the procedures.",
            "you-currently-have-a-pending-withdrawal": "You currently have a pending withdrawal request.",
            "withdraw": "Withdraw",
            "withdraw-application": "Withdraw application",
            "download-the-withdraw-application": "Download the withdraw application",
            "complete-the-form": "Please complete the form",
            "upload-the-form-below": "Please upload the completed form below",
            "completed-withdrawal-application-copy": "Completed withdrawal application",
            "responsibility-disclaimer": "I pledge that all information provided in this application is correct, and that if proven otherwise, I will be fully responsible for the results.",
