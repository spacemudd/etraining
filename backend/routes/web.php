...
use App\Http\Controllers\AttendanceReportRecordAbsenceNotesController;
...
use App\Http\Controllers\Back\TraineesAbsenceNotesController;
...
Route::middleware(['auth:sanctum', 'verified'])->group(function() {
    ...
    Route::prefix('back')->middleware('redirect-trainees-to-dashboard')->name('back.')->group(function() {
        ...
        Route::get('trainees/absence-notes', [TraineesAbsenceNotesController::class, 'index'])->name('trainees.absence-notes.index');
        Route::post('trainees/absence-notes/{id}/approve', [TraineesAbsenceNotesController::class, 'approve'])->name('trainees.absence-notes.approve');
        Route::post('trainees/absence-notes/{id}/reject', [TraineesAbsenceNotesController::class, 'reject'])->name('trainees.absence-notes.reject');
    ...
    Route::prefix('trainees')->name('trainees.')->group(function() {
        ...
        Route::get('attendance-report-record/{absence_note_id}/absence-notes/edit', [AttendanceReportRecordAbsenceNotesController::class, 'edit'])->name('attendance-report-record.absence-notes.edit');
        ...
        Route::put('attendance-report-record/{absence_note_id}/absence-notes/update', [AttendanceReportRecordAbsenceNotesController::class, 'update'])->name('attendance-report-record.absence-notes.update');
