...
return [
    ...
    | this many minutes (default 12 hours). When the pause expires, the next
    | inbound message restarts the workflow from the start node.
    |
    */
    'bot_pause_minutes' => (int) env('WHATSAPP_BOT_PAUSE_MINUTES', 720),
